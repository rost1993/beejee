<?php
	...
	require('../php-bin/classes/Sessions.php');
	...
	$navbar1 = "<nav class='navbar fixed-top navbar-expand-lg bg-dark'>"
			. "<a class='navbar-brand' href='../index.php' title='BeeJee Team'>"
			. "<img style='max-width: 60px; margin-top: -7px;' src='../images/beejee_header_en_new_white.png' alt='BeeJee Team'></a>"
	...
	switch($user_role) {
		case 0:
			$navbar2 = "<ul class='navbar-nav mr-auto'>"
						. "<li class='nav-item'>"
							. "<a class='text-white nav-link' id='list-tasks' href='../pages/list-tasks.php' title='Список задач'>Список задач</a>"
						. "</li>"						
			...
			$navbar2 = "<ul class='navbar-nav mr-auto'>"
					...
					. "<ul class='navbar-nav navbar-right'>"
						. "<li class='nav-item dropdown'>"
							...
							. "<div class='dropdown-menu dropdown-menu-right' aria-labelledby='user'>"
								. "<div class='dropdown-divider'></div>"
								. "<a class='dropdown-item' id='autorization' href='../php-bin/service-php/exit.php'><span class='fa fa-close'>&nbsp;</span>Выход</a>"
							. "</div>"
						. "</li>"
					. "</ul>"
				. "</div></nav>";
